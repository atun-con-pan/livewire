@if (session('success'))
    ...
    <div x-data="{ alertIsVisible: true }" x-show="alertIsVisible"
        class="mb-3 relative w-full overflow-hidden rounded-radius border border-success bg-surface text-on-surface dark:bg-surface-dark dark:text-on-surface-dark"
