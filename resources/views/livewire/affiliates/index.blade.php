<div>
    ...
    <div class="flex gap-2 mb-4">
        ...
        {{-- SOLO MOSTRAR SELECT SI EXISTE RANGO COMPLETO --}}
        ...
        <table class="w-full text-left text-sm text-on-surface dark:text-on-surface-dark">
            ...
            <thead class="border-b border-outline bg-surface-alt text-sm text-on-surface-strong dark:border-outline-dark dark:bg-surface-dark-alt dark:text-on-surface-dark-strong">
                <tr>
                    ...
                    {{-- SOLO MOSTRAR ESTADO SI HAY RANGO COMPLETO --}}
                    @if ($start_date && $end_date)
            ...
            <tbody class="divide-y divide-outline dark:divide-outline-dark">
                ...
                @forelse ($affiliates as $affiliate)
                    <tr class="border-t">
                        ...
                        {{-- SOLO CALCULAR ESTADO SI HAY RANGO COMPLETO --}}
                        @if ($start_date && $end_date)
                        ...
                        <td class="px-4 py-2 text-center">
                            <flux:button href="{{ route('affiliates.show', $affiliate) }}"
                                wire:navigate variant="primary" color="emerald"
                                size="sm" icon="exclamation-circle">
                                Detalles
                            </flux:button>
                        </td>
