<div>
    ...
    <div class="mb-4 flex items-center justify-between gap-2">
        ...
        <flux:button href="{{ route('documents.create') }}" wire:navigate variant="primary" color="blue" size="sm"
            icon="plus">
            Crear registro
        </flux:button>
    </div>

    <div class="flex flex-col md:flex-row gap-0 py-4 md:py-0 md:gap-4">
                    ...
                    @forelse ($documents as $document)
                        <tr class="border-t">
                            ...
                            <td class="p-2 max-w-md">
                                <a class="block text-info underline truncate"
            ...
            <div
                ...
                <div class="mt-3">
                    ...
                    <a href="{{ asset('storage/' . $document->file_path) }}" target="_blank"
                        class="text-sm text-info underline break-all">
                        {{ $document->file_name }}
                    </a>
                </div>

                <div class="mt-4">
                    <flux:button href="{{ route('documents.show', $document) }}" wire:navigate variant="primary"
